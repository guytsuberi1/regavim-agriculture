  ...
  properties: {
    rows: {
      ...
      items: {
        ...
        required: ["name", "total"],
        propertyOrdering: ["name", "customerNumber", "total", "date", "invoiceCount"],
      },
    },
  },
  required: ["rows"],
...
const PROMPT = [
  ...
  "- date: תאריך החשבונית האחרונה (המאוחרת ביותר) של הלקוח בפורמט dd/mm/yyyy;",
  "  גזור מתאריכי dd/mm/yy בדוח (yy: 19→2019, 26→2026).",
